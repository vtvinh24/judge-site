...
logger = logging.getLogger('judge.events.publishers.package_event')
...
def publish(payload: dict, broker_url: str = None, exchange_name: str = None, channel: str = None, appid: str = None):
    ...
    channel = channel or os.environ.get('EVENT_PACKAGE_CHANNEL', 'judge.package')
    ...
    logger.info('Published package event %s', envelope['id'])
